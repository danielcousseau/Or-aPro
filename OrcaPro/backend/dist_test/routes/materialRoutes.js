...
const MaterialController_1 = __importDefault(
...
router.post(
  "/",
  (0, validate_1.default)(materialSchema_1.materialSchema),
  MaterialController_1.default.criar,
);
router.put(
  "/:id",
  (0, validate_1.default)(materialSchema_1.materialSchema),
  MaterialController_1.default.atualizar,
);
