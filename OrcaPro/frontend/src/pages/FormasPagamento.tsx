...
export default function FormasPagamento() {
  ...
  const [formaEmEdicao, setFormaEmEdicao] = useState<FormaPagamento | null>(
    null,
  );
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert(
        `Forma de pagamento ${formaEmEdicao ? "atualizada" : "salva"} com sucesso!`,
      );
      limparFormulario();
      carregarFormas();
    } catch (error) {
  ...
  return (
    <div>
      <h1>
        {formaEmEdicao ? "Editar Forma de Pagamento" : "Formas de Pagamento"}
      </h1>
        ...
        <div className="cliente-card">
          <section className="form-section">
            ...
            <input
              ...
              required
              placeholder="Ex: 50% Entrada e 50% na Instalação (Pix)"
            />
          </section>
                ...
                >
                  ...
                  <div className="card-actions" style={{ marginTop: 0 }}>
                    ...
                    <button
                      ...
                      onClick={() => setFormaParaExcluir(forma.id)}
                    >
                      Excluir
                    </button>
                  </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-actions">
              <button
                type="button"
                className="btn-cancel"
                onClick={() => setFormaParaExcluir(null)}
              >
                Cancelar
              </button>
              <button
