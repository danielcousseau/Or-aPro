...
const opcaoCustomizadaRoutes_1 = __importDefault(require("./routes/opcaoCustomizadaRoutes"));
...
app.post('/api/forgot-password', authLimiter, AuthController_1.default.forgotPassword);
...
app.put('/api/usuarios/perfil', auth_1.default, AuthController_1.default.atualizarPerfil);
app.put('/api/usuarios/senha', auth_1.default, AuthController_1.default.alterarSenha);
