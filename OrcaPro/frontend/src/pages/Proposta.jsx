...
export default function Proposta() {
    ...
    return (
        <div className="proposta-outer" style={{ background: '#f9f9f9', minHeight: '100vh', padding: '20px', fontFamily: 'sans-serif' }}>
            <div className="no-print" style={{ maxWidth: '800px', margin: '0 auto 16px', display: 'flex', gap: '12px', justifyContent: 'center' }}>
