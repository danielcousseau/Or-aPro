      ...
      <div ref={ref} className="doc-page">
        ...
        {modo === "cliente" && (
          <div className="doc-saudacao">
            <p>
              Olá, <strong>{orcamento.cliente?.nome}</strong>! Preparamos o
              orçamento para o seu projeto <strong>{orcamento.titulo}</strong>.
            </p>
          </div>
        )}
        ...
        <div className="doc-grid">
          ...
          <section className="doc-section">
            ...
            <p>
              <strong>Ambiente:</strong> {orcamento.ambiente || "-"}
            </p>
            <p>
              <strong>Móvel:</strong> {orcamento.tipoMovel || "-"}
            </p>
          </section>
        </div>
        ...
        <div className="doc-total-box">
          <div className="doc-total-detalhes">
            <p>
              ...
              {orcamento.prazo || "A combinar"}
            </p>
            <p>
              <strong>Forma de pagamento:</strong>{" "}
              {orcamento.pagamento || "A combinar"}
            </p>
          </div>
        ...
        <footer className="doc-footer">
          ...
          <p>
            ...
            <strong>{orcamento.validade || "7 dias"}</strong>.
          </p>
        </footer>
      </div>
    );
